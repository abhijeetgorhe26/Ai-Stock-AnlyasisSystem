...
import { Eye, EyeOff, ArrowUpRight, AlertCircle, Loader2 } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Force full reload or router navigation so cookies & auth state sync cleanly
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  alert('Password reset link has been dispatched to your email if registered.');
                }}
